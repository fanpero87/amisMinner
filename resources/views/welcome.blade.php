    ...
    <div class="relative h-screen overflow-hidden bg-indigo-500">
        ...
        <div class="absolute z-30 flex w-1/2 h-full">
            <div class="relative z-30 w-11/12 my-auto space-y-10 text-white">
                ...
                <div class="pl-32">
                    <a href="/login"
                        class="flex items-center justify-center w-1/2 px-8 py-3 text-base font-semibold text-indigo-700 bg-indigo-100 border border-transparent rounded-md hover:bg-indigo-200 md:py-4 md:px-10 md:text-lg">
                        Login
                    </a>
                </div>
            </div>
